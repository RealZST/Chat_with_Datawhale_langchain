...
def model_to_llm(model:str=None, temperature:float=0.0, appid:str=None, api_key:str=None, Spark_api_secret:str=None,Wenxin_secret_key:str=None):
        """
        Returns a wrapped LLM instance based on the model parameter.
        
        Supported models:
        - ChatOpenAI: model,temperature,api_key
        - Wenxin_LLM: model,temperature,api_key,api_secret
        - Spark_LLM: model,temperature,appid,api_key,api_secret
        - ZhipuAILLM: model,temperature,api_key
        """
